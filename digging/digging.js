...
function check_next_pos(pos,it,past){
	...
	check_next_pos({x:pos.x,y:pos.y+1,p:pos},it)
	check_next_pos({x:pos.x,y:pos.y-1,p:pos},it)
	check_next_pos({x:pos.x-1,y:pos.y,p:pos},it)
	check_next_pos({x:pos.x+1,y:pos.y,p:pos},it)
	next.forEach(n => {
...
function path_to(e, tx, ty){
	...
	// trace(a)
	let next=[
		/*next_up=*/{x:last_pos.x,y:last_pos.y-1,p:last_pos},
		/*next_down=*/{x:last_pos.x,y:last_pos.y+1,p:last_pos},
		/*next_left=*/{x:last_pos.x-1,y:last_pos.y,p:last_pos},
		/*next_right=*/{x:last_pos.x+1,y:last_pos.y,p:last_pos},
	]
	next.forEach(n => {
